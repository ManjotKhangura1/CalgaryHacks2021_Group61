...
public class MainMenu extends Handler{
    ...
    public void load() {
        ...
        Main.arenaHeight = Integer.parseInt(stringOfObjects.subSequence(iIndex, fIndex).toString());
        iIndex = fIndex+1;
        //System.out.println(iIndex);
        //System.out.println(fIndex);
        fIndex = stringOfObjects.indexOf(',',fIndex + 1);

        Main.arenaWidth = Integer.parseInt(stringOfObjects.subSequence(iIndex, fIndex).toString());
    ...
    public void renderOptionsMenu() {
        ...
        addButton(new Button(50,30,400,100,cc,"Change Arena Size"));

        addButton(new Button(50,30,100,100,cc, Main.arenaHeight + "," + Main.arenaWidth));
        ...
        addButton(new Button(50,210,400,100,cc,"Amount of Traps"));

        //addButton(new Button(50,210,100,100,cc, handler.getNumOfTraps() + ""));
        ...
        //addButton(new Button(50,390,400,100,cc,"Amount of Obsticles"));

        //addButton(new Button(50,390,100,100,cc, handler.getNumOfObstacles() + ""));
